...
export async function getAdminSettings() {
  ...
  return {
    ...
    facebookUrl: item.facebook_url, facebookEnabled: Boolean(item.bat_facebook),
    instagramUrl: item.instagram_url, instagramEnabled: Boolean(item.bat_instagram),
    tiktokUrl: item.tiktok_url, tiktokEnabled: Boolean(item.bat_tiktok),
    ...
    youtubeEnabled: Boolean(item.bat_youtube),
